...
public class AssetApiVeneerImpl implements AssetApiVeneer
{
	...
	/* (non-Javadoc)
	 * @see com.mediasmiths.mayam.veneer.AssetApiVeneer#moveMediaEssence(com.mayam.wf.attributes.shared.type.AssetType, java.lang.String, com.mayam.wf.attributes.shared.type.AssetType, java.lang.String)
	 */
	@Override
