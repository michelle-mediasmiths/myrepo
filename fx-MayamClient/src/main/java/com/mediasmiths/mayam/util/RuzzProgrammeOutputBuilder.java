...
public class RuzzProgrammeOutputBuilder
{
	...
	private static Media buildMedia(FullProgrammePackageInfo pack)
	{
		...
		{
			SegmentListType.Segment rzSeg = SegmentUtil.convertMayamSegmentToRuzzSegment(segment, pack.getTitleAttributes().getAttributeAsString(Attribute.SERIES_TITLE));
