...
public class MediaCheckTest {
	...
	public void testValidMedia() throws IOException,
		...
		doTest(expectedSize, expectedMd5sum, true);
	...
	protected void doTest(long expectedSize, String expectedMd5sum,
		...
		assertTrue(shouldPass == toTest.mediaCheck(mxf, new MaterialEnvelope(
				new File(""), material)));
	}
	...
	public void testInvalidMediaWrongFileSize() throws IOException,
		...
		// calculated by textutils md5sum
		String expectedMd5sum = "da75f0c8711c0ec5ca5c2e0c11a8ac11";
		doTest(expectedSize, expectedMd5sum, false);
	}

	// test for file sizes matching but checksums not - media check should fail

	@Test
	public void testInvalidMediaWrongCheckSum() throws IOException,
			DatatypeConfigurationException {
