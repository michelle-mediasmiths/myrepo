...
public abstract class XmlWatchingAgent<T> implements StoppableService
{
	...
	private final Collection<Thread> messageProcessorThreads;
	...
	public XmlWatchingAgent(
			...
			DirectoryWatchingQueuer directoryWatcher,
			...
			ShutdownManager shutdownManager) throws JAXBException
	{
		...
		messageProcessorThreads = new ArrayList<Thread>();
	...
	public void addMessageProcessor(MessageProcessor messageProcessor){
		...
		messageProcessorThread.setName("MessageProcessor");
	...
	public void shutdown()
	{
		...
		for (Thread messageProcessorThread : messageProcessorThreads)
		{
