...
public class JobBuilder
{
	...
	public String buildJobForTxPackageTranscode(String packageID,
	                                            String inputfile,
	                                            String outputFolder) throws MayamClientException, JobBuilderException, UnknownPathException
	{

		log.info(String.format("Building job for tx package transcode packageId %s inputfile %s outputfolder %s",
		                       packageID,
		                       inputfile,
		                       outputFolder));
	...
	private String setInputAndOutputPaths(String packageID,
	                                      String inputfile,
	                                      String outputFolder,
	                                      String pcp) throws UnknownPathException
	{
	...
	{
		log.debug(String.format("determining prority for job for asset %s tx date is %s",
