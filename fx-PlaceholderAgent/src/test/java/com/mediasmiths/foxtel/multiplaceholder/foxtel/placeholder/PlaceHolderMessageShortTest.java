...
public abstract class PlaceHolderMessageShortTest
{
	...
	protected MultiPlaceholderMessageValidator validator;
	protected MultiPlaceholderMessageProcessor processor;
	...
	public void before() throws IOException, JAXBException, SAXException
	{
		...
		validator = new MultiPlaceholderMessageValidator(unmarhsaller, mayamClient, mayamValidator, new ReceiptWriter(), new SchemaValidator("PlaceholderManagement.xsd"), ChannelProperties);
		
		processor = new MultiPlaceholderMessageProcessor(new SingleFilePickUp(new File[] {File.createTempFile("test", "test")}, "xml"), validator, new ReceiptWriter(), unmarhsaller, marshaller, mayamClient, events);
