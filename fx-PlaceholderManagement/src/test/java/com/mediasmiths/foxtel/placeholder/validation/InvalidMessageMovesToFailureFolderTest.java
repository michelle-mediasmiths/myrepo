...
public class InvalidMessageMovesToFailureFolderTest extends
		PlaceholderManagerTest {

	private static Logger logger = Logger.getLogger(InvalidMessageMovesToFailureFolderTest.class);
	
	public InvalidMessageMovesToFailureFolderTest() throws JAXBException,
			SAXException {
		super();
	}
	
	@Test
	public void testInvalidMessageMovesToFailureFolder() throws IOException, InterruptedException{
		//prepare folders
		...
		String messageFilePath = messagePath +IOUtils.DIR_SEPARATOR+ "INVALIDMESSAGE.xml";				
