...
public class CreateOrUpdateTitleTest extends PlaceHolderMessageShortTest
{
	...
	public void testValidAddTitleProcessingFailsOnQueryingExistingTitle()
		...
		// the call we are testing
		processor.createOrUpdateTitle((CreateOrUpdateTitle) pm.getActions().getCreateOrUpdateTitleOrPurgeTitleOrAddOrUpdateMaterial().get(0));
	}
	...
	public void testCreateTitleInvalidDates() throws IOException, Exception {
		...
		validator.validateCreateOrUpdateTitle((CreateOrUpdateTitle) pm.getActions().getCreateOrUpdateTitleOrPurgeTitleOrAddOrUpdateMaterial().get(0));
